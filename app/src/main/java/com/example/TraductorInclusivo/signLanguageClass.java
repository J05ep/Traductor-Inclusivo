...
import com.example.imagepro.Api.RegistrarAPI;
...
public class  signLanguageClass {
    ...
    signLanguageClass(Button clear_button, Button add_button, Button space_button, Button fin_button, TextView change_text, String id, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
    ...
    private void guardarHistorial(int id){
        ...
        String url = "http://"+IP+"/traductor";

        RestAdapter adapter = new RestAdapter.Builder()
                .setEndpoint(url)
                .build();
        RegistrarAPI api = adapter.create(RegistrarAPI.class);
        ...
        api.guardarHistorial(
                ...
                new Callback<Response>() {
                    ...
                    public void success(Response result, Response response) {
                        ...
                        try{
                            System.out.println("ID: "+id+" Texto: "+final_text+" Fecha: "+date);
